...
int main(int argc, char *argv[]){
	...
	string sol_a = argv[1], sol_b = argv[2], checker = argv[3];
	...
	for(auto i = 0; ; ++ i){
		...
		check_status(system(("(cat ./in; printf \"\\n\"; cat ./stress/out_a; printf \"\\n\"; cat ./stress/out_b;) | ./" + checker + " > ./stress/res").c_str()), checker);
		ifstream in_res("./stress/res"), in_a("./stress/out_a"), in_b("./stress/out_b");
		int res;
		in_res >> res;
		vector<string> a, b;
